def buildBurrow():
	...
	curlJsonDict(output,	"Featured: 9/11",			"manual",	"https://conspyre.tv/roku.json?program_id=59662")

	curlJsonDict(output,	"DisclosureHub Films",			"manual",	"https://conspyre.tv/roku.json?program_id=59975")
	curlJsonDict(output,	"DisclosureHub Picks",			"manual",	"https://conspyre.tv/roku.json?program_id=59976")
	curlJsonDict(output,	"Hollywood Exposed",			"manual",	"https://conspyre.tv/roku.json?program_id=59977")
	curlJsonDict(output,	"Banned Pandemic Doctors",		"manual",	"https://conspyre.tv/roku.json?program_id=59978")
	curlJsonDict(output,	"Lost Covid Videos",			"manual",	"https://conspyre.tv/roku.json?program_id=59979")
	curlJsonDict(output,	"Hidden Health Wealth",			"manual",	"https://conspyre.tv/roku.json?program_id=59980")
	curlJsonDict(output,	"Remedies of Covid",			"manual",	"https://conspyre.tv/roku.json?program_id=59981")
	curlJsonDict(output,	"Real Law Knowledge",			"manual",	"https://conspyre.tv/roku.json?program_id=59982")
	curlJsonDict(output,	"Quantum Human Capabilities",		"manual",	"https://conspyre.tv/roku.json?program_id=59983")
	curlJsonDict(output,	"Human Trafficking / Elite Pedophelia",	"manual",	"https://conspyre.tv/roku.json?program_id=59984")
	curlJsonDict(output,	"Rituals and Satanic Cults",		"manual",	"https://conspyre.tv/roku.json?program_id=59985")
	curlJsonDict(output,	"New World Order", 				"manual",	"https://conspyre.tv/roku.json?program_id=59986")
	curlJsonDict(output,	"Free Energy", 					"manual",	"https://conspyre.tv/roku.json?program_id=59987")
	curlJsonDict(output,	"EMF/EMR/RF/5G Radiation",		"manual",	"https://conspyre.tv/roku.json?program_id=59988")
	curlJsonDict(output,	"Extraterrestrial Videos",		"manual",	"https://conspyre.tv/roku.json?program_id=59989")
	curlJsonDict(output,	"Vaccines Exposed",				"manual",	"https://conspyre.tv/roku.json?program_id=59990")
