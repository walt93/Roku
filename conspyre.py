...
#	curlJsonDict(output, "Featured",						"manual", "https://conspyre.tv/roku.json?program_id=58493")
	...
	curlJsonDict(output, "5G", 					"most_popular", "https://conspyre.tv/roku.json?program_id=59660")
	curlJsonDict(output, "5G Crisis: Awareness & Accountability", "most_popular", "https://conspyre.tv/roku.json?program_id=59661")
	curlJsonDict(output, "9/11", 				"most_popular", "https://conspyre.tv/roku.json?program_id=59662")
#	curlJsonDict(output, "Adair, David",		"most_popular",  "https://conspyre.tv/roku.json?catName=david-adair")
	curlJsonDict(output, "Bernard, Ronald", 	"most_popular", "https://conspyre.tv/roku.json?program_id=59685")
	curlJsonDict(output, "Cooper, William", 	"most_popular", "https://conspyre.tv/roku.json?program_id=59686")
	curlJsonDict(output, "Cult of the Medics", "chronological", "https://conspyre.tv/roku.json?program_id=59688")
	...
	curlJsonDict(output, "Disney", "most_popular", "https://conspyre.tv/roku.json?program_id=59689")
	curlJsonDict(output, "Egypt",				"most_popular",  "https://conspyre.tv/roku.json?catName=egypt")
	curlJsonDict(output, "Enthéos Shines Fan Channel", "most_popular", "https://conspyre.tv/roku.json?program_id=59692")
	curlJsonDict(output, "Epstein, Jeffrey",	"most_popular", "https://conspyre.tv/roku.json?program_id=59693")
	...
	curlJsonDict(output, "Finders, The",		"most_popular", "https://conspyre.tv/roku.json?program_id=59694")
	curlJsonDict(output, "Freemasons",			"most_popular", "https://conspyre.tv/roku.json?program_id=59695")
	curlJsonDict(output, "Gates, Bill", 		"most_popular", "https://conspyre.tv/roku.json?program_id=59696")
	curlJsonDict(output, "General", 			"most_popular", "https://conspyre.tv/roku.json?catName=conspyre-tv")
	curlJsonDict(output, "Geoengineering", 		"most_popular", "https://conspyre.tv/roku.json?program_id=59697")
	curlJsonDict(output, "Giants",				"most_popular", "https://conspyre.tv/roku.json?program_id=59698")
	curlJsonDict(output, "Great Reset",			"most_popular", "https://conspyre.tv/roku.json?program_id=59699")
	curlJsonDict(output, "Gunderson, Ted",		"most_popular", "https://conspyre.tv/roku.json?program_id=59835")
